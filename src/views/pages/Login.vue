<template>
    ...
    <spinner :isLoading="data.isLoading" />
            <div class="login-page">
                <div class="card" :class="{slideactive : isslideactive }" style="background-image: url('images/components/login/bg.jpg')">
                    <div class="left"> 
                        <h3>Belum punya akun?</h3>
                        <button type="button" class="register-btn" @click="slideactive">Register</button>
                    </div>
                    <div class="right">
                        <h3>Sudah pernah register?</h3>
                        <button type="button" @click="slideactive" class="login-btn">Login</button>
                    </div>
                    <div class="form">
                        <div class="login-form" :class="{formhidden: isslideactive}">
                            ...
                            <button type="button" @click="getLogin" class="submit-btn">Login</button>
                        </div>
